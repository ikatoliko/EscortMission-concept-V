...
public abstract class StatGiver<T> : StatGiver where T : StatSO {
    ...
    public virtual List<StatValue<Z>> GetStats<Z>() where Z : StatSO => Stats as List<StatValue<Z>>;
    public SignedStatValueList<Z> GetSignedStats<Z>() where Z : StatSO => new SignedStatValueList<Z>(this as StatGiver<Z>, GetStats<Z>());
}
...
public abstract class StatGiver<T, U> : StatGiver<T> where T : StatSO where U : StatSO {
    ...
    public override List<StatValue<Z>> GetStats<Z>() => Stats2 as List<StatValue<Z>> ?? base.GetStats<Z>();
}
...
public abstract class StatGiver<T, U, G> : StatGiver<T, U> where T : StatSO where U : StatSO where G : StatSO {
    ...
    public override List<StatValue<Z>> GetStats<Z>() => Stats3 as List<StatValue<Z>> ?? base.GetStats<Z>();
}